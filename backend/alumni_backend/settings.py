...
ASGI_APPLICATION = 'alumni_backend.asgi.application'
...
# For production, configure S3 storage separately
...
PREMIUM_FEATURES_ENABLED = config('PREMIUM_FEATURES_ENABLED', default=True, cast=bool)
